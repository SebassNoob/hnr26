...
class LightsOutDialog(QDialog):
    def __init__(self, minutes_left):
        ...
        # Stacked Widget to swap between screens (Warn -> Bargain -> Loading -> Result)
...
def show_warning_dialog(minutes_left):
    """
    Spawns the PyQt6 window and returns minutes added.
    Since this runs in a separate Process, we create a new QApplication.
    """
    # Create application instance if one doesn't exist
